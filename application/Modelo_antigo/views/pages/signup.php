...
<meta name="theme-color" content="#563d7c">
  ...
  <img class="mb-4" src="img/pomer.png" alt="" width="72" height="72">
  ...
  <label for="inputPassword" class="sr-only">Password</label>
	...
	<p>
		<a href="<?=base_url()?>index.php/login">Already Have an Account?</a>
	</p>
  <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
  <p class="mt-5 mb-3 text-muted">&copy; ANDSYSTEM 2023</p>
</form>
</body>
</html>
